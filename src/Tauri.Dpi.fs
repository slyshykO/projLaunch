...
module rec Dpi =
    ...
    type LogicalSize(width: float, height: float) =
        ...
        member _.width
            ...
            and set (_: float): unit = nativeOnly
    ...
    type Size(size: U2<LogicalSize, PhysicalSize>) =
        member _.size
            with get (): U2<LogicalSize, PhysicalSize> = nativeOnly
            and set (_: U2<LogicalSize, PhysicalSize>): unit = nativeOnly
    ...
    type Position(position: U2<LogicalPosition, PhysicalPosition>) =
        member _.position
            with get (): U2<LogicalPosition, PhysicalPosition> = nativeOnly
            and set (_: U2<LogicalPosition, PhysicalPosition>): unit = nativeOnly
